<template>
  <section class="flex justify-center pb-24 pt-6 bg-[#fff]">
    <div class="w-11/12">
      <h1 class="pb-6 text-5xl font-bold text-center uppercase">
        Subscribe to our news letter
      </h1>
      <p class="pb-12 text-center">
        Enter your email to get latest from Technology Guru
      </p>
