      ...
      <section class="flex justify-center pt-24 pb-16 bg-gray-10 z-[-1] bg-transparent">
        <div class="container grid items-center px-3 sm:w-full sm:grid-cols-2 2xl:px-16 place-items-center">
          <div class="text-gray-700 sm:row-start-1">
            ...
            <div class="">
              <button
                class="px-6 w-full  rounded-tr-full rounded-br-full rounded-full mx-auto sm:w-6/12 sm:text-sm lg:w-4/12 p-3 md:text-base my-3 font-semibold text-gray-100 transition-all duration-100 bg-[#0245A3] hover:bg-[#0245a3b6] active:shadow">
                Get Started
              </button>
            </div>
          </div>
